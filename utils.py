...
from query_strategies import RandomSampling, EntropySampling, EntropySamplingDropout, BALDDropout, AdversarialAttack,AdversarialAttack_efficient,KCenterGreedy,ClusterMarginSampling,HybridSampling
...
params = {
    'MSSEG':
        {'n_epoch': 200,
         ...
         'val_args': {'batch_size': 256,'shuffle':False, 'num_workers': 2,'drop_last':False},
         'test_args': {'batch_size': 256,'shuffle':False, 'num_workers': 2,'drop_last':False},
